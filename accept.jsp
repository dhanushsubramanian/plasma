...
<%
System.out.println("update bank set status='"+status+"',d2=(current_timestamp()) where id='"+request.getParameter("id")+"'");
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/plasma","root","root");
	...
	ps.executeUpdate();
response.sendRedirect("viewreq.jsp?Accepted Successful");
