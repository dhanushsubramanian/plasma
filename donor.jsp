...
<div id="tooplate_wrapper">
    ...
    <br>
<h2><b><center>Donor Login</center></h2> <br> 
<form action="donor1.jsp">
&nbsp &nbsp<label for="name"style="; font-family:Times New Roman; font-size:20px;">User name:</label>
<input type="text" name="name" placeholder="enter name" id="name"style="; font-family:Times New Roman;" required>
  <br>
  <br>&nbsp&nbsp&nbsp&nbsp
 <label for="password"style="; font-family:Times New Roman; font-size:20px; ">Password:</label>
<input type="password" name="password" placeholder="enter password"  id="password"style="; font-family:Times New Roman;"required> &nbsp  
  <br>
  <br>
  <center>
...
<br>
<br>
Not registered?<a href="donorreg.jsp">Click here!</a>
</center>
    </div>	
