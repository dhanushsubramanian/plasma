...
<div id="tooplate_wrapper">
    ...
    <br>
<h2><b><center>Hospital Login</center></h2> <br> 
<form action="hospital1.jsp">
&nbsp &nbsp &nbsp<label for="hname"style="; font-family:Times New Roman; font-size:20px;">Name</label>
  &nbsp<input type="text" name="hname" placeholder="enter name" id="name"style="; font-family:Times New Roman;" required>
  <br>
  <br>
 <label for="psw"style="; font-family:Times New Roman; font-size:20px; ">Password</label>
&nbsp<input type="password" name="psw" placeholder="enter password"  id="psw"style="; font-family:Times New Roman;"required> &nbsp  
  <br>
  <br>
  <center>
...
<br>
<br>
Not registered?<a href="hospitalreg.jsp">Click here!</a>
</center>
    </div>	
