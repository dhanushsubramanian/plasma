...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_menu" class="ddsmoothmenu">
        <ul>
            ...
            <li><a href="hospital.jsp" class="selected">Hospital Login</a></li>
        </ul>
        <br style="clear: left" />
    ...
    <br>
<h2><b><center>Hospital Register</center></h2> <br> 
<form action="hospitalreg1.jsp">
<table>
<tr><td>Hospital Name:</td>
<td><input type="text" name="hname"placeholder="enter hospital name"required="required"></input></td></tr>
<tr><td>&nbsp&nbspPassword:</td>
<td><input type="text" name="psw"placeholder="enter password"required="required"></input></td></tr>
<tr><td>Address</td>
<td><textarea type="text" name="address" required="required"placeholder="enter address"></textarea></td></tr>
<tr><td>Contact Number:</td>
<td><input type="text" name="contact"placeholder="enter number"required="required"></input></td></tr>
</table> 
  <br>
  <center>
 <button type="submit">Register</button>&nbsp &nbsp 
