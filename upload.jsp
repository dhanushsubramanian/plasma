...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_menu" class="ddsmoothmenu">
        <ul>
            ...
            <li><a href="upload.jsp" class="selected">upload certificate</a>
            </li>
            <li><a href="profile.jsp">view profile</a>
            </li>
    ...
    %>
<h2><b><center>upload covid-19 recovered certificate</center></h2>
<center>
<form action="upload1.jsp">
<tr><td>User name:</td> 
<td><input type="text" value="<%=name%>" /></td>&nbsp &nbsp&nbsp&nbsp&nbsp<br></br>
</tr>
&nbsp&nbsp<tr><td>Upload file:</td>
<td><input type="file" name="file" id="file1"style="color:black; font-family:Times New Roman;"></input></td></tr>
<center>
<br>
 <button type="submit">upload</button>&nbsp &nbsp
</form>
</center>
   </div>	
