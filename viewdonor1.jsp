...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_menu" class="ddsmoothmenu">
        <ul>
            ...
            <li><a href="viewdonor1.jsp"class="selected">view donors</a></li>
            <li><a href="viewstatus.jsp">View status</a></li>
             <li><a href="viewhreq.jsp">view request</a></li>
            <li><a href="viewfeedback.jsp">view feedback</a></li> 
             <!-- <li><a href="viewchats.jsp">View chats</a></li> -->
...
<h2><b><center>View Donors</center></h2>  
<br>
<center>
<table cellspacing="8" border="2" width="60%">
	...
	PreparedStatement pstmt = con.prepareStatement("select * from donor1");
...
<tr>
 ...
 <%
						...
						PreparedStatement pstmt1 = con.prepareStatement("select * from donor where name='"+rs.getString(1)+"'");
		...
		<td align="center"name="name"><font color="Black"required><%=rs1.getString("dat")%></font></td>		
			
				<td style="border:white"><a href="sendreq.jsp?name=<%=rs1.getString(2)%>&&bd=<%=rs1.getString(7)%>">Request</a></td>	
				<% 
