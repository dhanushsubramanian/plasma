...
<h2><b><center>View Status</center></h2> 
<center>  
<table cellspacing="8" border="2" width="60%">
 ...
 Class.forName("com.mysql.jdbc.Driver");
	Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/plasma", "root", "root");                  
						PreparedStatement pstmt = con.prepareStatement("select * from bank where name='"+name+"'");
						ResultSet rs = pstmt.executeQuery();
						while(rs.next()){

					%> 
	<tr>
	             <td align="center"name="bname"><font color="Black"><%=rs.getString(5)%></font></td>
				 <td align="center"name="bd"><font color="Black"><%=rs.getString(3)%></font></td>
				<td align="center"name="name"><font color="Black"><%=rs.getString(2)%></font></td>	 
				<td align="center"name="name"><font color="Black"><%=rs.getString("d1")%></font></td>	 
				<td align="center"name="name"><font color="Black"><%=rs.getString("d2")%></font></td>	 
				<td><a href="addblood.jsp?name=<%=rs.getString(2)%>&&bd=<%=rs.getString(3)%>"><font color="green">add blood</font></a></td>
				</tr>	
				<% 
			    }
			}catch(Exception e){
